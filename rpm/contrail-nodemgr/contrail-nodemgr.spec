...
scons -j 4 --opt=%{_sconsOpt} -U control-node:node_mgr
scons -j 4 --opt=%{_sconsOpt} -U vrouter:node_mgr
scons -j 4 --opt=%{_sconsOpt} -U opserver:node_mgr
scons -j 4 --opt=%{_sconsOpt} -U database:node_mgr
scons -j 4 --opt=%{_sconsOpt} -U src:nodemgr
