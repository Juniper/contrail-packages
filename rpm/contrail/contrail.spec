...
%else
%define         _kvers      3.10.0-229.el7.x86_64 3.10.0-327.10.1.el7.x86_64 3.10.0-957.12.2.el7.x86_64
%endif
...
%endif
%config(noreplace) /etc/contrail/supervisord_config.conf
%config(noreplace) /etc/contrail/supervisord_config_files/contrail-api.ini
/etc/contrail/supervisord_config_files/contrail-config.rules
%config(noreplace) /etc/contrail/supervisord_config_files/contrail-discovery.ini
%config(noreplace) /etc/contrail/supervisord_config_files/contrail-schema.ini
%config(noreplace) /etc/contrail/supervisord_config_files/contrail-device-manager.ini
